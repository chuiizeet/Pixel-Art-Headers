...
@interface SDAVAssetExportSession : NSObject
{
    ...
    NSArray *_metadata;
    AVAsset *_audio_asset;
    AVAssetReader *_reader;
    AVAssetReader *_reader2;
...
@property(retain, nonatomic) AVAssetReader *reader2; // @synthesize reader2=_reader2;
@property(retain, nonatomic) AVAssetReader *reader; // @synthesize reader=_reader;
@property(copy, nonatomic) AVAsset *audio_asset; // @synthesize audio_asset=_audio_asset;
@property(nonatomic) _Bool final_video; // @synthesize final_video=_final_video;
@property(nonatomic) _Bool rotate_later; // @synthesize rotate_later=_rotate_later;
@property(nonatomic) _Bool force_rotate; // @synthesize force_rotate=_force_rotate;
