...
@interface GPUImageMovie : GPUImageOutput <AVPlayerItemOutputPullDelegate>
{
    ...
    CDStruct_1b6d18a9 _current_Frame_Time;
    CDStruct_1b6d18a9 _first_Frame_Time;
}

@property(nonatomic) CDStruct_1b6d18a9 first_Frame_Time; // @synthesize first_Frame_Time=_first_Frame_Time;
@property(nonatomic) CDStruct_1b6d18a9 current_Frame_Time; // @synthesize current_Frame_Time=_current_Frame_Time;
