...
@property(nonatomic) _Bool use_bitrate; // @synthesize use_bitrate=_use_bitrate;
...
- (void)dealloc;
- (id)initWithMovieURL:(id)arg1 size:(struct CGSize)arg2 fileType:(id)arg3 outputSettings:(id)arg4 use_bitrate:(_Bool)arg5 bitrate:(int)arg6;
- (id)initWithMovieURL:(id)arg1 size:(struct CGSize)arg2 use_bitrate:(_Bool)arg3 bitrate:(int)arg4;
